...
sudo docker run -d --restart=always --name=registry -p 5000:5000 -v /var/overmind_data/registry:/var/lib/registry:rw registry:2
sudo docker run -d --restart=always --name=jenkins -p 8080:8080 -p 50000:50000 -u root -v /var/overmind_data/jenkins_home/:/var/jenkins_home/:rw jenkins
